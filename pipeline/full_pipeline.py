...
def create_alpaca_broker(paper: bool = True) -> AlpacaBrokerAdapter:
    """
    Create Alpaca broker adapter from environment variables.
    ...
    Returns:
        AlpacaBrokerAdapter configured for paper or live trading
